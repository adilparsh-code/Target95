...
const pageTitle = { absolute: "Blog & Knowledge Hub | Target95+" };
const pageDescription = "Practical explainers, board updates, coding, AI, development and opportunities for students and learners.";

export const metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/blog" },
  openGraph: { type: "website", url: "/blog", siteName: "Target95+", locale: "en_US", title: pageTitle, description: pageDescription },
