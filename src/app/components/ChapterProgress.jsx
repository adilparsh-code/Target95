  ...
  return (
    <section className="mt-10 rounded-2xl border border-gray-200 bg-slate-50 p-6" aria-labelledby="chapter-progress-heading">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 id="chapter-progress-heading" className="text-2xl font-bold text-gray-900">
            Learning Progress
          </h2>
      ...
      <div className="mt-5 h-3 w-full overflow-hidden rounded-full bg-gray-200">
        <div className="h-full rounded-full bg-blue-600 transition-all duration-500" style={{ width: `${completionPercentage}%` }} />
      </div>
