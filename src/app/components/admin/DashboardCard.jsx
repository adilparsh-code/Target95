export default function DashboardCard({ title, value, subtitle, icon, trend, trendUp = true, color = "blue" }) {
  const colorMap = {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 group">
      <div className="flex items-start justify-between">
        ...
        <div className={`w-12 h-12 rounded-lg ${bgMap[color]} flex items-center justify-center text-xl group-hover:scale-110 transition-transform`}>
