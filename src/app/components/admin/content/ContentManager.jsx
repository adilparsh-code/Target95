...
export default function ContentManager() {
  ...
  return <div className="space-y-6">
    ...
    <ContentEditor key={editorOpen ? `open-${editing?.id ?? "new"}` : "closed"} entity={entity} item={editing} isOpen={editorOpen} onClose={() => { setEditorOpen(false); setEditing(null); }} onSave={async (item) => { await save(item); setPage(0); }} />
