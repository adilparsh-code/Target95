        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <SortHeader label="Chapter" sortKey="chapter" activeSortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
              <SortHeader label="Subject" sortKey="subject" activeSortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
              ...
              <SortHeader label="Views" sortKey="views" activeSortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
              <SortHeader label="Uploaded" sortKey="uploaded" activeSortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
