      ...
      units: [
        ...
        },
        {
          ...
          theory: [
            ...
            'Allocation of keys to fingers on four different rows',
          ...
          practicalActivities: [
            ...
            'Demonstrate to type text, numbers, special characters',
            'Practice correct typing ergonomics',
            'Practice placing fingers on correct keys',
            'Practice various mouse operations',
            'Identify user interface of typing tutor',
            'Practice typing text in typing tutor software',
            'Work in lesson editor',
        ...
        },
        {
          ...
          practicalActivities: [
            'List available word processing applications',
            'Start a new document',
            'Open and save a document',
            'Demonstrate cut, copy, paste, and move text',
          ],
        },
        {
          id: '402-ix-b4',
          ...
          theory: [
            'Formatting tool',
            'Dialog boxes to format values',
            'Referencing: Relative, Mixed, Absolute',
            'Types of charts',
          ],
          practicalActivities: [
            'Format cells with decimal places and labels',
            'Demonstrate fill handle for series',
            'Use Relative, Mixed, and Absolute referencing',
            'Create charts in spreadsheet',
          ],
        },
        {
          id: '402-ix-b5',
          ...
          practicalActivities: [
            ...
            'Insert and format images and tables',
          ],
        },
      ],
    },
...
const cbse402Class10 = {
      ...
      units: [
        {
          id: '402-x-b1',
          code: '1',
          name: 'Digital Documentation (Advanced) using LibreOffice Writer',
          hours: { theory: 12, practical: 18 },
          marks: 8,
          chapters: [
            { number: 1, title: 'Introduction to Styles' },
            { number: 2, title: 'Working with Images' },
            { number: 3, title: 'Advanced Features of Writer' },
          ],
          learningOutcomes: [
            'Apply styles to create consistent formatting',
            'Insert and format images/drawing objects',
            'Create and maintain Table of Contents',
            'Use and edit templates',
            'Track and review changes',
          ],
          theory: [
            'Styles and Formatting',
            'Inserting images, resizing, cropping',
          ...
          practicalActivities: [
            'Apply styles using Styles panel',
            'Position images with wrapping and alignment',
        ...
        },
        {
          id: '402-x-b2',
          code: '2',
          name: 'Electronic Spreadsheet (Advanced) using LibreOffice Calc',
          hours: { theory: 15, practical: 23 },
          marks: 10,
          chapters: [
            { number: 4, title: 'Analyse data using scenarios and goal seek' },
            { number: 5, title: 'Using Macros in Spreadsheet' },
            { number: 6, title: 'Linking Spreadsheet Data' },
            { number: 7, title: 'Share and Review a Spreadsheet' },
          ],
          learningOutcomes: [
            'Consolidate data and apply what-if analysis',
            'Use Goal Seek and Solver',
            'Record and execute macros',
            'Link data across external sources',
          ],
          theory: [
            'Consolidating Data and Subtotals',
            'What-if Scenarios, Goal Seek, Solver',
            'Macro creation and functions',
            'External links and shared spreadsheets',
          ],
          practicalActivities: [
            'Create What-if scenarios',
            'Record and run simple macros',
            'Link external data sources',
            'Merge and compare spreadsheets',
          ],
        },
        {
          id: '402-x-b3',
          code: '3',
          name: 'Database Management System using LibreOffice Base',
          hours: { theory: 18, practical: 27 },
          marks: 12,
          chapters: [
            { number: 8, title: 'Introduction to DBMS' },
            { number: 9, title: 'Starting with LibreOffice Base' },
            { number: 10, title: 'Working with Multiple Tables' },
            { number: 11, title: 'Queries in Base' },
            { number: 12, title: 'Forms and Reports' },
          ],
          learningOutcomes: [
            'Understand RDBMS concepts',
            'Create tables and assign primary keys',
            'Establish table relationships',
            'Construct queries, forms, and reports',
          ],
          theory: [
            'RDBMS terminology',
          ...
          practicalActivities: [
            'Build database tables with Design View',
            'Define One-to-Many relationships',
            'Run criteria-based queries',
            'Generate custom forms and reports',
          ],
        },
        {
          id: '402-x-b4',
          code: '4',
          name: 'Maintain Healthy, Safe and Secure Working Environment',
          hours: { theory: 15, practical: 22 },
          marks: 10,
          chapters: [
            { number: 13, title: 'Health, Safety and Security at Workplace' },
            { number: 14, title: 'Workplace Quality Measures' },
            { number: 15, title: 'Prevent Accidents and Emergencies' },
          ],
          learningOutcomes: [
            'Identify workplace hazards and follow safety protocols',
            'Apply ergonomics and maintain environmental quality',
            'Execute emergency evacuation and first aid procedures',
          ],
          theory: [
            'Safety policies and hazard controls',
            'Office ergonomics and health safety',
            'Emergency services and accident handling',
          ],
          practicalActivities: [
            'Demonstrate basic first aid and fire safety',
            'Simulate workplace evacuation plans',
          ],
        },
      ],
    },
  ...
  practicalAssessment: {
    practicalExamination: 20,
    vivaVoce: 10,
    projectWorkFieldVisit: 10,
    portfolioPracticalFile: 10,
  },
};
