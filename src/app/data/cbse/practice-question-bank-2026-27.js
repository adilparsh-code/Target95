...
export const cbsePracticeQuestions2026_27 = [
  ...
  },
  {
    ...
    options: ['43', '44', '45', '46'],
    answer: '45',
    explanation: '(101101)₂ = (1 × 32) + (0 × 16) + (1 × 8) + (1 × 4) + (0 × 2) + (1 × 1) = 45.',
  ...
  },
  {
    ...
    answer: 'num = int(input("Enter an integer: "))\nif num > 0:\n    print("Positive")\nelif num < 0:\n    print("Negative")\nelse:\n    print("Zero")',
    explanation: 'Compare the input with zero using if/elif/else: greater than 0 is positive, less than 0 is negative, otherwise zero.',
  ...
  },
  {
    ...
    answer: 'A relative reference changes when copied to another cell (e.g., A1). An absolute reference remains locked and fixed to a specific row and column (e.g., $A$1).',
    explanation: 'Relative references adapt based on relative position, whereas absolute references use dollar signs ($) to prevent row and column changes when copied.',
  ...
  },
  {
    ...
    answer: 'The relationship is one-to-many from Class to Student. ClassID is the primary key of Class, and Student.ClassID acts as the foreign key referencing it.',
    explanation: 'One class can contain many students, making Class the primary side and Student the related foreign key side.',
