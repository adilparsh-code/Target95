/**
 * CBSE curriculum tracks for session 2026-27.
 * Keep subject codes separate: CS 083, IP 065, IT 402, IT 802.
 */
...
export const getCBSESubjectTrack = (code) =>
  cbseSubjectTracks.find((subject) => subject.code === String(code)) ?? null;
