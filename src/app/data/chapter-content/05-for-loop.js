const chapter05 = {
  ...
  "introduction": {
    "description": "The for loop is used to repeat a block of code a specific number of times. It combines initialization, condition checking, and increment in one line.",
    "realLifeExamples": [
  ...
  "theoryNotes": {
    "beginnerExplanation": "Beginner-friendly explanation of FOR Loop.",
    "importantPoints": [
      "Point 1",
      "Point 2",
      "Point 3",
