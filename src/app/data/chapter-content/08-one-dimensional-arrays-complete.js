...
public class Main {
    ...
    hard: [
      {
        id: "array-pg-h-1",
        question: "Write a program to find the missing number in an array containing numbers 1 to N.",
        solution: `import java.util.Scanner;
public class Main {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
    ...
    public static void main(String[] args) {
      ...
      {
        id: "array-pg-h-3",
        question: "Write a program to implement bubble sort and display the array after each pass.",
        solution: `public class Main {
    public static void main(String[] args) {
        int[] arr = {64, 34, 25, 12, 22, 11, 90};
        int n = arr.length;
    ...
    public static void printArray(int[] arr) {
        ...
        output: "Shows array after each pass of bubble sort",
      },
      {
        id: "array-pg-h-4",
    ...
    public static void main(String[] args) {
      ...
      {
        id: "array-pg-h-5",
        question: "Write a program to sort an array of 0s, 1s, and 2s (Dutch National Flag problem).",
        solution: `public class Main {
    public static void main(String[] args) {
      ...
      {
        id: "array-pg-h-6",
        question: "Write a program to find the maximum subarray sum using Kadane's Algorithm.",
        solution: `public class Main {
    public static void main(String[] args) {
...
public class Main {
    public static void main(String[] args) {
      ...
      {
        id: "array-pg-h-8",
        question: "Write a program to find the majority element in an array (appears more than n/2 times).",
        solution: `public class Main {
    public static void main(String[] args) {
  ...
  challengeProblems: [
    {
      ...
      question: "Given an array of size n containing numbers from 1 to n, find the missing number and the repeating number.",
      solution: `public class Main {
    public static void main(String[] args) {
        int[] arr = {4, 3, 6, 2, 1, 1};
        int n = arr.length;
    ...
    },
    {
      id: "array-cp-2",
      title: "Trapping Rain Water",
      question: "Given an array of non-negative integers representing elevation, compute how much water can be trapped after raining.",
      solution: `public class Main {
    public static void main(String[] args) {
    ...
    },
    {
      ...
      question: "Given an array of stock prices, find the maximum profit that can be achieved by buying and selling once.",
      solution: `public class Main {
    public static void main(String[] args) {
    ...
    },
    {
      ...
      question: "Given an array, find the length of the longest consecutive elements sequence.",
...
public class Main {
    public static void main(String[] args) {
      ...
      output: "Longest consecutive sequence: 4",
    },
    {
      id: "array-cp-5",
      title: "Rotate Matrix 90 Degrees",
      question: "Given a 2D array (matrix), rotate it 90 degrees clockwise.",
      solution: `public class Main {
    public static void main(String[] args) {
        int[][] matrix = {
            {1, 2, 3},
    ...
    },
    {
      id: "array-cp-6",
      title: "Find Subarray with Given Sum",
      question: "Find a continuous subarray that adds up to a given number.",
      solution: `import java.util.Scanner;
public class Main {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
      ...
      output: "Enter target sum: 33\nSubarray found from index 2 to 4",
    },
    {
      id: "array-cp-7",
      title: "Wave Array",
      question: "Sort an array in wave form (a[0] >= a[1] <= a[2] >= a[3]...).",
      solution: `public class Main {
    public static void main(String[] args) {
    ...
    },
    {
      ...
      question: "Given an array of chocolate packets, distribute m chocolates to n students such that the difference between max and min is minimized.",
      solution: `import java.util.Arrays;
public class Main {
    public static void main(String[] args) {
  ...
  previousYearQuestions: [
    {
      id: "array-py-1",
      question: "(ICSE 2023) Write a program to input 10 integers in an array and find the sum of all even numbers.",
      answer: "int[] arr = new int[10];\nint sum = 0;\nfor (int i = 0; i < 10; i++) {\n    if (arr[i] % 2 == 0) {\n        sum = sum + arr[i];\n    }\n}\nSystem.out.println(sum);",
      explanation: "Loop through array, check if each element is even, add to sum.",
    },
    {
      id: "array-py-2",
      question: "(ICSE 2023) Write a program to search for an element in an array using linear search.",
      answer: "int index = -1;\nfor (int i = 0; i < arr.length; i++) {\n    if (arr[i] == target) {\n        index = i;\n        break;\n    }\n}\nif (index != -1) {\n    System.out.println('Found at ' + index);\n}",
      explanation: "Linear search checks each element sequentially until target is found.",
    },
    {
      id: "array-py-3",
      question: "(ICSE 2022) Write a program to sort an array using bubble sort.",
      answer: "for (int i = 0; i < n - 1; i++) {\n    for (int j = 0; j < n - i - 1; j++) {\n        if (arr[j] > arr[j + 1]) {\n            int temp = arr[j];\n            arr[j] = arr[j + 1];\n            arr[j + 1] = temp;\n        }\n    }\n}",
      explanation: "Bubble sort repeatedly compares adjacent elements and swaps if out of order.",
    },
    {
      id: "array-py-4",
      question: "(ICSE 2022) Write a program to find the second largest element in an array.",
      answer: "int largest = arr[0], second = Integer.MIN_VALUE;\nfor (int i = 1; i < arr.length; i++) {\n    if (arr[i] > largest) {\n        second = largest;\n        largest = arr[i];\n    } else if (arr[i] > second && arr[i] != largest) {\n        second = arr[i];\n    }\n}",
      explanation: "Track both largest and second largest in single pass.",
    },
    {
      id: "array-py-5",
      question: "(ICSE 2021) Write a program to merge two sorted arrays.",
      answer: "int[] merged = new int[n1 + n2];\nint i = 0, j = 0, k = 0;\nwhile (i < n1 && j < n2) {\n    if (arr1[i] <= arr2[j]) merged[k++] = arr1[i++];\n    else merged[k++] = arr2[j++];\n}\nwhile (i < n1) merged[k++] = arr1[i++];\nwhile (j < n2) merged[k++] = arr2[j++];",
      explanation: "Use three pointers to merge two sorted arrays in O(n1+n2) time.",
    },
    {
      id: "array-py-6",
      question: "(ICSE 2021) Write a program to find the frequency of a given element in an array.",
      answer: "int count = 0;\nfor (int i = 0; i < arr.length; i++) {\n    if (arr[i] == target) {\n        count++;\n    }\n}\nSystem.out.println('Frequency: ' + count);",
      explanation: "Loop through array and count occurrences of target element.",
    },
  ],
  ...
  aiVivaQuestions: [
    {
      ...
      answer: "An array is a collection of elements of the same data type stored at contiguous memory locations. It is an object in Java, and its size is fixed once created.",
    },
    {
      id: "array-av-2",
      question: "What is the default value of array elements in Java?",
      answer: "Default values: 0 for numeric types (int, double, etc.), false for boolean, and null for object types (String, etc.).",
    },
    {
      id: "array-av-3",
      question: "What is ArrayIndexOutOfBoundsException?",
      answer: "It's a runtime exception that occurs when you try to access an array element with an invalid index (e.g., accessing arr[5] in an array of size 5, where valid indices are 0-4).",
    },
    {
      id: "array-av-4",
      question: "What is the difference between arr.length and arr.length()?",
      answer: "arr.length is a property (field) that returns the size of the array. arr.length() is not valid for arrays (it's used for String). For arrays, use arr.length without parentheses.",
    },
    {
      id: "array-av-5",
      question: "Can you change the size of an array after creation?",
      answer: "No, array size is fixed once created. To 'resize', you need to create a new array and copy elements from the old array.",
    },
    {
      id: "array-av-6",
      question: "What is linear search?",
      answer: "Linear search is a searching algorithm that checks each element of the array sequentially until the target element is found or the end of the array is reached. Time complexity: O(n).",
    },
    {
      id: "array-av-7",
      question: "What is binary search?",
      answer: "Binary search is an efficient searching algorithm that works on sorted arrays. It repeatedly divides the search interval in half. Time complexity: O(log n).",
    },
    {
      id: "array-av-8",
      question: "Why does binary search require a sorted array?",
      answer: "Binary search works by comparing the target with the middle element and deciding which half to search. This only works if the array is sorted.",
    },
    {
      id: "array-av-9",
      question: "What is bubble sort?",
      answer: "Bubble sort is a simple sorting algorithm that repeatedly compares adjacent elements and swaps them if they are in the wrong order. Time complexity: O(n²).",
    },
    {
      id: "array-av-10",
      question: "What is the difference between for loop and enhanced for loop?",
      answer: "For loop provides index access and allows modification of elements. Enhanced for loop is simpler but doesn't provide index and the loop variable is a copy.",
    },
    {
      id: "array-av-11",
      question: "Are arrays passed by value or by reference?",
      answer: "Arrays are passed by reference. When you pass an array to a method, the method receives a reference to the original array, so changes made in the method affect the original array.",
    },
    {
      id: "array-av-12",
      question: "What happens when you assign one array to another?",
      answer: "Both variables reference the same array object. Changes through one reference are visible through the other. This is because arrays are reference types.",
    },
    {
      id: "array-av-13",
      question: "What is the time complexity of bubble sort?",
      answer: "Bubble sort has O(n²) time complexity in the worst and average cases. It's simple but inefficient for large arrays.",
    },
    {
      id: "array-av-14",
      question: "What is selection sort?",
      answer: "Selection sort finds the minimum element in the unsorted portion of the array and swaps it with the first element of the unsorted portion. Time complexity: O(n²).",
    },
    {
      id: "array-av-15",
      question: "What is insertion sort?",
      answer: "Insertion sort builds the sorted array one element at a time by inserting each element into its correct position in the sorted portion. Time complexity: O(n²), but efficient for small/nearly sorted arrays.",
    },
    {
      id: "array-av-16",
      question: "What is the output of: int[] arr = new int[5]; System.out.println(arr[0]);",
      answer: "The output is 0. When an int array is created, all elements are initialized to the default value 0.",
    },
    {
      id: "array-av-17",
      question: "What is the difference between == and equals() for arrays?",
      answer: "== compares references (memory addresses), not contents. equals() for arrays also compares references. To compare contents, use Arrays.equals(arr1, arr2).",
    },
    {
      id: "array-av-18",
      question: "Can you create an array without specifying its size?",
      answer: "No, array size must be specified when creating the array (except when using array initializer like int[] arr = {1, 2, 3}).",
    },
    {
      id: "array-av-19",
      question: "What is a jagged array?",
      answer: "A jagged array is a 2D array where each row can have a different number of columns. In Java, 2D arrays are arrays of arrays, so they can be jagged.",
    },
    {
      id: "array-av-20",
      question: "What is the output of: int[] arr = {1, 2, 3}; for(int i=0; i<arr.length; i++) { System.out.print(arr[i] + ' '); }",
      answer: "The output is: 1 2 3. The loop prints all elements of the array.",
    },
  ],

  // ========== 17. PRACTICE TEST ==========
  practiceTest: {
    title: "ONE DIMENSIONAL ARRAYS - Practice Test",
    duration: "60 minutes",
    totalMarks: 50,
    ...
    sections: [
      {
        ...
        marks: 10,
        questions: [
          { id: "pt-1", question: "Array indices in Java start at _____ .", options: ["1", "0", "-1", "Depends on size"], answer: 1 },
          { id: "pt-2", question: "What is the last index of an array of size 10?", options: ["9", "10", "11", "0"], answer: 0 },
          { id: "pt-3", question: "What is the default value of int array elements?", options: ["1", "0", "-1", "null"], answer: 1 },
          { id: "pt-4", question: "Which exception is thrown for invalid array index?", options: ["NullPointerException", "ArrayIndexOutOfBoundsException", "IOException", "ArithmeticException"], answer: 1 },
          { id: "pt-5", question: "What is the time complexity of binary search?", options: ["O(n)", "O(log n)", "O(n²)", "O(1)"], answer: 1 },
        ],
      },
      {
      ...
      },
      {
        ...
        marks: 20,
        questions: [
          { id: "pt-9", question: "Write a program to find the sum of all elements in an array.", answer: "int sum = 0;\nfor (int i = 0; i < arr.length; i++) {\n    sum = sum + arr[i];\n}\nSystem.out.println(sum);" },
          { id: "pt-10", question: "Write a program to implement linear search.", answer: "int index = -1;\nfor (int i = 0; i < arr.length; i++) {\n    if (arr[i] == target) {\n        index = i;\n        break;\n    }\n}" },
          { id: "pt-11", question: "Write a program to sort an array using bubble sort.", answer: "for (int i = 0; i < n - 1; i++) {\n    for (int j = 0; j < n - i - 1; j++) {\n        if (arr[j] > arr[j + 1]) {\n            int temp = arr[j];\n            arr[j] = arr[j + 1];\n            arr[j + 1] = temp;\n        }\n    }\n}" },
        ],
      },
      {
        ...
        marks: 10,
        questions: [
          { id: "pt-12", question: "What is the output?\nint[] arr = {1, 2, 3};\nint[] brr = arr;\nbrr[0] = 100;\nSystem.out.println(arr[0]);", answer: "100", explanation: "Arrays are reference types. brr and arr point to same array." },
  ...
  revisionNotes: [
    "Array indices start at 0 and go up to length-1.",
    "Array length is fixed — cannot be changed after creation.",
    "All elements in an array must be of the same data type.",
    "Default values: 0 for int, false for boolean, null for objects.",
    "arr.length returns the size (not arr.length()).",
    "ArrayIndexOutOfBoundsException occurs when accessing invalid index.",
    "Arrays are passed to methods by reference.",
    "Linear search: O(n) time complexity, works on any array.",
    ...
    "Enhanced for loop (for-each) doesn't provide index.",
    "Two arrays assigned to each other reference the same array.",
    "Use i < arr.length (not i <= arr.length) in loops.",
  ],

  // ========== 19. CHEATSHEET ==========
  cheatsheet: {
    title: "ONE DIMENSIONAL ARRAYS - Quick Reference",
    syntax: "int[] arr = new int[size];  or  int[] arr = {1, 2, 3};",
    keyPoints: [
      "Indices start at 0, last index is length-1",
      "Length is fixed once created",
      "All elements must be same type",
      "Default values: 0 for int, false for boolean, null for objects",
      "arr.length returns size (property, not method)",
      "Arrays are reference types",
      "Passed to methods by reference",
    ],
    commonOperations: [
      { operation: "Traverse", code: "for (int i = 0; i < arr.length; i++) { ... }" },
      { operation: "Find max/min", code: "int max = arr[0]; for(i=1; i<length; i++) if(arr[i] > max) max = arr[i];" },
      { operation: "Linear search", code: "for (int i = 0; i < arr.length; i++) { if (arr[i] == target) return i; }" },
      { operation: "Bubble sort", code: "for i: for j: if(arr[j] > arr[j+1]) swap" },
      { operation: "Reverse", code: "for (int i = 0; i < n/2; i++) { swap(arr[i], arr[n-1-i]); }" },
    ],
    searching: [
      { name: "Linear Search", complexity: "O(n)", requirement: "Any array" },
      { name: "Binary Search", complexity: "O(log n)", requirement: "Sorted array" },
    ],
    sorting: [
      { name: "Bubble Sort", complexity: "O(n²)", note: "Simple but inefficient" },
      { name: "Selection Sort", complexity: "O(n²)", note: "Finds minimum each time" },
      { name: "Insertion Sort", complexity: "O(n²)", note: "Efficient for small arrays" },
    ],
  },
  ...
  interviewQuestions: [
    {
      ...
      answer: "An array is a collection of elements of the same data type stored at contiguous memory locations. It allows storing multiple values in a single variable, with each element accessed by its index.",
    },
    {
      id: "array-iq-2",
      question: "What is the default value of array elements?",
      answer: "Default values: 0 for numeric types, false for boolean, null for object types. Arrays are initialized with these defaults when created.",
    },
    {
      id: "array-iq-3",
      question: "What is ArrayIndexOutOfBoundsException?",
      answer: "It's a runtime exception that occurs when you try to access an array element with an invalid index. For example, accessing arr[5] in an array of size 5 (valid indices: 0-4).",
    },
    {
      id: "array-iq-4",
      question: "Can you change the size of an array?",
      answer: "No, array size is fixed once created. To resize, you need to create a new array and copy elements from the old array. Use ArrayList for dynamic size.",
    },
    {
      id: "array-iq-5",
      question: "What is the difference between linear and binary search?",
      answer: "Linear search: O(n), works on any array, checks each element sequentially. Binary search: O(log n), requires sorted array, divides search space in half each time.",
    },
    {
      id: "array-iq-6",
      question: "What are the different sorting algorithms you know?",
      answer: "Bubble sort (O(n²)), Selection sort (O(n²)), Insertion sort (O(n²) but efficient for small arrays), Merge sort (O(n log n)), Quick sort (O(n log n) average).",
    },
    {
      id: "array-iq-7",
      question: "How are arrays passed to methods?",
      answer: "Arrays are passed by reference. The method receives a reference to the original array, so changes made in the method affect the original array.",
    },
    {
      id: "array-iq-8",
      question: "What is the difference between == and equals() for arrays?",
    ...
    },
    {
      ...
      answer: "The enhanced for loop (for-each loop) is a simplified way to traverse arrays. Syntax: for(type var : array). It doesn't provide the index and the loop variable is a copy.",
    },
    {
      id: "array-iq-10",
      question: "What is the time complexity of bubble sort?",
      answer: "Bubble sort has O(n²) time complexity in worst and average cases. It's simple to understand but inefficient for large arrays.",
    },
    {
      id: "array-iq-11",
      question: "When would you use binary search over linear search?",
      answer: "Use binary search when the array is sorted and you need efficient searching. It's much faster (O(log n)) than linear search (O(n)), but requires the array to be sorted first.",
    },
    {
      id: "array-iq-12",
      question: "What is a jagged array?",
    ...
    },
    {
      ...
      answer: "Use arr.length property (not a method). It returns the number of elements in the array. For example, if arr has 5 elements, arr.length returns 5.",
    },
    {
      id: "array-iq-14",
      question: "What is the difference between arr[0] and arr[1]?",
      answer: "arr[0] accesses the first element (index 0). arr[1] accesses the second element (index 1). Array indices start at 0 in Java.",
    },
    {
      id: "array-iq-15",
      question: "Can an array store different data types?",
      answer: "No, all elements in an array must be of the same data type. If you need to store different types, use an array of Object type, but that's not recommended.",
    },
  ],
  ...
  examTricks: [
    "Always remember: array indices start at 0, not 1.",
    "The last valid index is arr.length - 1, not arr.length.",
    "Use i < arr.length (not i <= arr.length) to avoid ArrayIndexOutOfBoundsException.",
    "arr.length is a property, not a method — no parentheses.",
    "Arrays are passed by reference — changes in methods affect the original array.",
    "Binary search requires sorted array — remember this for exam questions.",
    "Linear search: O(n), Binary search: O(log n).",
    "Bubble sort: compare adjacent elements and swap.",
    "Selection sort: find minimum, place at beginning.",
    "Insertion sort: build sorted array one element at a time.",
    "Default values: 0 for int, false for boolean, null for objects.",
    "Two arrays assigned to each other point to the same array.",
    "Enhanced for loop cannot modify original array elements.",
    "For sorting questions, know all three: bubble, selection, and insertion sort.",
    "For searching questions, know both: linear and binary search.",
  ],

  // ========== 22. ASSERTION & REASON QUESTIONS ==========
  assertionReason: [
    {
      id: "onedimensionalarrayscomplete-ar-1",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-2",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-3",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-4",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-5",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-6",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-7",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-8",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-9",
    ...
    {
      id: "onedimensionalarrayscomplete-ar-10",
  ...
  debugTheCode: [
    {
      id: "onedimensionalarrayscomplete-dc-1",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-2",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-3",
      question: "Find and fix the bug:\nint sum = 0;\nfor (int i = 1; i <= 10; i++);\n    sum = sum + i;\nSystem.out.println(sum);",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-4",
      question: "Find and fix the bug:\nint i = 5;\nwhile (i >= 1)\n    System.out.println(i);\n    i--;",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-5",
      question: "Find and fix the bug:\nint num = 123;\nint sum = 0;\nwhile (num > 0) {\n    int digit = num % 10;\n    sum = sum + digit;\n}\nSystem.out.println(sum);",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-6",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-7",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-8",
      question: "Find and fix the bug:\nint i = 1;\nwhile (i <= 5);\n    System.out.println(i);",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-9",
    ...
    {
      id: "onedimensionalarrayscomplete-dc-10",
      question: "Find and fix the bug:\nint i = 1;\nwhile (i <= 10) {\n    if (i == 5)\n        continue;\n    System.out.println(i);\n    i++;\n}",
  ...
  caseStudyQuestions: [
    {
      id: "onedimensionalarrayscomplete-cs-1",
      ...
      questions: [
        {
          id: "onedimensionalarrayscomplete-cs-1-q1",
        ...
        {
          id: "onedimensionalarrayscomplete-cs-1-q2",
        ...
        {
          id: "onedimensionalarrayscomplete-cs-1-q3",
    ...
    {
      id: "onedimensionalarrayscomplete-cs-2",
      ...
      questions: [
        {
          id: "onedimensionalarrayscomplete-cs-2-q1",
        ...
        {
          id: "onedimensionalarrayscomplete-cs-2-q2",
        ...
        {
          id: "onedimensionalarrayscomplete-cs-2-q3",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "onedimensionalarrayscomplete-cs-3-q2",
        ...
        {
          id: "onedimensionalarrayscomplete-cs-3-q3",
  ...
  mixedPracticeSets: [
    {
      id: "onedimensionalarrayscomplete-mps-1",
      title: "Practice Set 1: One-dimensional array Fundamentals",
      questions: [
        {
          type: "mcq",
          id: "onedimensionalarrayscomplete-mps-1-q1",
        ...
        {
          type: "fillInTheBlank",
          id: "onedimensionalarrayscomplete-mps-1-q2",
          question: "An entry-controlled loop checks the condition _____ each iteration.",
          answer: "before"
        },
        {
          type: "output",
          id: "onedimensionalarrayscomplete-mps-1-q3",
          question: "int i = 1;\nwhile (i <= 3) {\n    System.out.print(i + \" \");\n    i++;\n}",
          answer: "1 2 3"
        },
        {
          type: "trueFalse",
          id: "onedimensionalarrayscomplete-mps-1-q4",
          question: "A while loop can be converted to a for loop.",
          answer: true
        },
        {
          type: "shortAnswer",
          id: "onedimensionalarrayscomplete-mps-1-q5",
    ...
    {
      id: "onedimensionalarrayscomplete-mps-2",
      title: "Practice Set 2: One-dimensional array Applications",
      questions: [
        {
          type: "mcq",
          id: "onedimensionalarrayscomplete-mps-2-q1",
        ...
        {
          type: "output",
          id: "onedimensionalarrayscomplete-mps-2-q2",
          question: "int i = 5;\nwhile (i >= 1) {\n    System.out.print(i--);\n}",
          answer: "54321"
        },
        {
          type: "errorFinding",
          id: "onedimensionalarrayscomplete-mps-2-q3",
          question: "int i = 1;\nwhile (i <= 5);\n    System.out.println(i);",
  ...
  rapidRevisionQuestions: [
    { id: "onedimensionalarrayscomplete-rr-1", question: "What type of loop is a while loop?", answer: "Entry-controlled loop" },
    { id: "onedimensionalarrayscomplete-rr-2", question: "How many times does a while loop execute if condition is false initially?", answer: "0 times" },
    { id: "onedimensionalarrayscomplete-rr-3", question: "Where is the loop variable initialized in a while loop?", answer: "Before the while loop" },
    { id: "onedimensionalarrayscomplete-rr-4", question: "Where is the loop variable updated in a while loop?", answer: "Inside the while loop body" },
    { id: "onedimensionalarrayscomplete-rr-5", question: "What happens if you forget to update the loop variable?", answer: "Infinite loop" },
    { id: "onedimensionalarrayscomplete-rr-6", question: "Which loop is best when the number of iterations is unknown?", answer: "While loop" },
    { id: "onedimensionalarrayscomplete-rr-7", question: "Which loop is best when the number of iterations is known?", answer: "For loop" },
    { id: "onedimensionalarrayscomplete-rr-8", question: "What does while(true) create?", answer: "An infinite loop" },
    { id: "onedimensionalarrayscomplete-rr-9", question: "Which statement exits a loop immediately?", answer: "break" },
    { id: "onedimensionalarrayscomplete-rr-10", question: "Which statement skips the current iteration?", answer: "continue" },
    { id: "onedimensionalarrayscomplete-rr-11", question: "Can a while loop be nested?", answer: "Yes" },
    { id: "onedimensionalarrayscomplete-rr-12", question: "Can a while loop be converted to a for loop?", answer: "Yes" },
    { id: "onedimensionalarrayscomplete-rr-13", question: "What is a sentinel value?", answer: "A special value that signals end of input" },
    { id: "onedimensionalarrayscomplete-rr-14", question: "What is the scope of a variable declared inside a loop?", answer: "Only within the loop" },
    { id: "onedimensionalarrayscomplete-rr-15", question: "What is the difference between while and do-while?", answer: "While checks before (may not execute), do-while checks after (always executes once)" },
    { id: "onedimensionalarrayscomplete-rr-16", question: "What is a nested loop?", answer: "A loop inside another loop" },
    { id: "onedimensionalarrayscomplete-rr-17", question: "What is the time complexity of a simple loop running n times?", answer: "O(n)" },
    { id: "onedimensionalarrayscomplete-rr-18", question: "What is the output of: int i=1; while(i<=3) { System.out.print(i); i++; }", answer: "123" },
    { id: "onedimensionalarrayscomplete-rr-19", question: "What is the output of: int i=5; while(i>=1) { System.out.print(i--); }", answer: "54321" },
    { id: "onedimensionalarrayscomplete-rr-20", question: "What is the purpose of the break statement?", answer: "To exit the loop immediately" },
  ],
