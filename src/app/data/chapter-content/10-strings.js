const chapter10 = {
  ...
  "introduction": {
    "description": "Strings in Java are objects representing sequences of characters. They are immutable — once created, their value cannot be changed. Java provides a rich set of methods for string manipulation.",
    "realLifeExamples": [
  ...
  "theoryNotes": {
    "beginnerExplanation": "Beginner-friendly explanation of Strings.",
    "importantPoints": [
      "Point 1",
      "Point 2",
      "Point 3",
  ...
  "longAnswerQuestions": [
    {
      ...
      "answer": "Long answer for Strings."
    },
    {
      "id": "strings-la-2",
