const chapter11 = {
  ...
  "introduction": {
    "description": "A method is a reusable block of code that performs a specific task. Methods help organize code, avoid repetition, and make programs modular.",
    "realLifeExamples": [
  ...
  "theoryNotes": {
    "beginnerExplanation": "Beginner-friendly explanation of Methods.",
    "importantPoints": [
      "Point 1",
      "Point 2",
      "Point 3",
  ...
  "longAnswerQuestions": [
    {
      ...
      "answer": "Long answer for Methods."
    },
    {
      "id": "methods-la-2",
