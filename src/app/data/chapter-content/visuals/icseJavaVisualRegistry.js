...
export const icseJavaVisuals = [
  ...
  {
    id: "java-recursion-call-stack",
    chapterSlug: "recursion",
    title: "Java Recursion Call Stack",
    purpose: "Trace recursive calls down to the base case and then back through stack unwinding.",
    caption: "Each recursive call adds a stack frame; the base case stops further calls before the stack unwinds.",
    alt: "Factorial recursion call-stack diagram showing calls from factorial 4 down to the base case and results returning upward.",
    assetType: "flowchart",
    priority: "Tier 1",
    sourceSection: "Recursion",
    path: "/visuals/icse-java/java-recursion-call-stack.svg",
  },
  {
    id: "java-recursion-call-stack-methods",
    chapterSlug: "methods",
    title: "Recursion Call Stack",
    purpose: "Show how recursive method calls build stack frames and unwind after the base case.",
    caption: "The same recursion visual is available from the Methods chapter because recursion is taught there as a core method concept.",
    alt: "Factorial recursion call-stack diagram showing recursive calls and stack unwinding.",
    assetType: "flowchart",
    priority: "Tier 1",
