...
export const ISC_AI_XII_THEORY = [
  { id: 'xii-applications-ai', title: 'Applications of AI', weightage: 10, topics: ['NLP applications: Named Entity Recognition and text summarisation', 'Python NLP workflow and spaCy-style entity extraction', 'Statistics: mean, median, mode, range, variance and standard deviation', 'Probability basics and uniform, normal and binomial distributions', 'Hypothesis testing, null/alternative hypotheses and Type I/II errors', 'Simple classification and regression applications', 'AI in healthcare and medical diagnosis', 'AI in finance: fraud detection and risk applications', 'AI in education, transportation and agriculture', 'Benefits, risks, limitations and societal implications of AI applications'] },
  { id: 'xii-ai-paradigms', title: 'Different Paradigms of AI: Neural Networks, Machine Learning and Deep Learning', weightage: 15, topics: ['Artificial neural networks and biological inspiration', 'Neurons, nodes, weights and layers', 'Input, hidden and output layers', 'Forward propagation and backward propagation', 'Artificial neural network model and multilayer perceptron', 'Handwritten-digit recognition with MLP as a conceptual example', 'Machine learning: learning from data for prediction/decision making', 'Supervised and unsupervised learning', 'Decision-tree model as an ML example', 'Deep learning and multi-layer neural networks', 'CNNs for image/pattern recognition', 'ML/DL applications, advantages, limitations and ethics'] },
  { id: 'xii-ann', title: 'Practical Implications of Artificial Neural Networks', weightage: 15, topics: ['Data preparation with NumPy and Pandas', 'Preprocessing: scaling and encoding categorical variables', 'Train/test splitting', 'Building ANN with beginner-friendly Keras/TensorFlow concepts', 'Network architecture and activation functions', 'Forward pass, loss and backpropagation', 'Weight updates and training iterations', 'Classification and regression outputs', 'Evaluation and interpretation of ANN results', 'Practical applications and limitations'] },
  { id: 'xii-ml', title: 'Practical Implications of Machine Learning', weightage: 20, topics: ['End-to-end ML workflow', 'Data acquisition, cleaning and preprocessing', 'Feature/label selection', 'Encoding and scaling', 'Training and testing data', 'Classification and regression', 'Decision-tree and linear-regression applications', 'Confusion matrix: TP, TN, FP, FN', 'Accuracy, precision, recall and F1-style error interpretation', 'Overfitting and underfitting', 'Generalisation and model limitations', 'Choosing evaluation measures according to application risk'] },
