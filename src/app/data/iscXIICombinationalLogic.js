...
export const COMBINATIONAL_LOGIC = {
  encoder: {
    ...
    truthTable: [{ input: "D0=1", output: "00" }, { input: "D1=1", output: "01" }, { input: "D2=1", output: "10" }, { input: "D3=1", output: "11" }],
  ...
  decoder: {
    ...
    truthTable: [{ input: "00", output: "Y0=1" }, { input: "01", output: "Y1=1" }, { input: "10", output: "Y2=1" }, { input: "11", output: "Y3=1" }],
  ...
  multiplexer: {
    ...
    selectTable: [{ S1: 0, S0: 0, selected: "D0" }, { S1: 0, S0: 1, selected: "D1" }, { S1: 1, S0: 0, selected: "D2" }, { S1: 1, S0: 1, selected: "D3" }],
  ...
  halfAdder: {
    ...
    truthTable: [{ A: 0, B: 0, S: 0, C: 0 }, { A: 0, B: 1, S: 1, C: 0 }, { A: 1, B: 0, S: 1, C: 0 }, { A: 1, B: 1, S: 0, C: 1 }],
  ...
  fullAdder: {
    ...
    truthTable: [{ A: 0, B: 0, Cin: 0, S: 0, Cout: 0 }, { A: 0, B: 0, Cin: 1, S: 1, Cout: 0 }, { A: 0, B: 1, Cin: 0, S: 1, Cout: 0 }, { A: 0, B: 1, Cin: 1, S: 0, Cout: 1 }, { A: 1, B: 0, Cin: 0, S: 1, Cout: 0 }, { A: 1, B: 0, Cin: 1, S: 0, Cout: 1 }, { A: 1, B: 1, Cin: 0, S: 0, Cout: 1 }, { A: 1, B: 1, Cin: 1, S: 1, Cout: 1 }],
  ...
  viva: ["Why does an encoder require one active input in its basic form?", "Why are select lines necessary in a MUX?", "Why does a full adder need a carry-in?", "How can a full adder be constructed using two half adders?"]
};
