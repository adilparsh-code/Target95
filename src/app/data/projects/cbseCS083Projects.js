...
Average on-time rate: 33.3 %`,
    ...
    viva: [
      ...
      "Why should database rows be converted into Python records before calculating the analytics summary?",
    ],
    extensions: [
      ...
      "Export a summary as a CSV file for use in another application.",
    ],
    syllabusMapping: [
      ...
      "Uses Python to process and present query results.",
      "Supports the CBSE practical assessment structure (Python/SQL/practical file/viva).",
    ],
  },
];
