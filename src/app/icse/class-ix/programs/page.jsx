...
import programs from '@/app/data/icseClass9Programs';

export const metadata = { title: 'ICSE Class IX Java Programs | Target95' };

export default function ClassIXProgramsPage() {
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-10 text-slate-900 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <Link href="/icse/class-ix" className="text-sm font-medium text-slate-600 hover:text-slate-900">← Back to Class IX</Link>
        <header className="mt-6 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
          <p className="text-sm font-semibold uppercase tracking-wider text-slate-500">ICSE • Computer Applications • Class IX</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Java Programming Practice</h1>
          <p className="mt-3 max-w-3xl text-slate-600">20 recommended programs arranged from fundamentals to problem-solving. This is the normal programming/lab work; the Ethical Computing written project is separate.</p>
