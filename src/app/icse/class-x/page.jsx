...
const modules = [
  ...
  { title:'Robotics & AI', text:'The separate ICSE Class X Artificial Intelligence theory, Python and project pathway.', href:'/icse/robotics-ai/class-x', badge:'AI Track' },
];
