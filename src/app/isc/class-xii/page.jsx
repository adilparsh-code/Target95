...
const modules = [
  {
    ...
    description: "Truth tables, logic gates, Boolean laws, minterms/maxterms, canonical SOP/POS, K-Maps and combinational logic.",
    href: "/isc/class-xii/boolean-algebra",
    badge: "Flagship",
    topics: ["Truth Tables", "Logic Gates", "K-Map", "Combinational Logic"],
  },
];
